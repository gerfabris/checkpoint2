    ...
    return(
        <footer>
                ...
                <div className="row">
                    ...
                    <div className="col-md-2 col-lg-2 mx-auto my-md-4 my-0 mt-4 mb-1 container">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><p>
                                <Link to={"/Cards"}>API Rick & Morty</Link>
                            </p></li>
                        </ul>
                    </div>
                    <hr className="clearfix w-100 d-md-none"/>    
                    <div className="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">    
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><p>
                                <BsFillEnvelopeFill className='footer__icons'/>checkpoint2@skillfactory.com.ar
                            </p></li>
                            <li>
                            <p>
            ...
            <div className="container footer__copyright text-center">
                <Link to={"/"}> Copyright © 2022 | Germán Fabris</Link>
            </div>
        </footer>    
    )
}